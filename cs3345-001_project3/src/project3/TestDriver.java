 ...
 * constants.
 * 
 * @see {@link project3.TestDriver.TaggedTestExecutionSummary#getSummaryByTag(String)} for the code that
...
{
	private static final String PACKAGE = "project3";
	private static final Class<?> CLASS = LazyBinarySearchTreeTest.class;
	private static final List<String> TAGS = LazyBinarySearchTreeTest.TAGS;
	...
	public static void main(String[] args)
	{
		...
		CharSequence sectionBreak = new StringBuilder()
	...
	private static class TaggedTestExecutionSummary
	{
		...
		private static TestExecutionSummary getSummaryByTag(String tag)
		{
			LauncherDiscoveryRequest request = LauncherDiscoveryRequestBuilder.request()
					.selectors(
				    		selectPackage("project3"),
				        selectClass(LazyBinarySearchTreeTest.class)
				    	)
				    .filters(
